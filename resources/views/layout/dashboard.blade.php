...
@section('gambar','dashboard.png')

@section('content')
<div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->
        <div data-u="loading" class="jssorl-004-double-tail-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="/assetAdmin/img/double-tail-spin.svg" />
        </div>
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
            <div style="background-color:#000000;">
                <img data-u="image" style="opacity:0.5;" src="/assetAdmin/img/px-action-athlete-athletes-848618-image.jpg" />
                <div data-ts="flat" data-p="320" style="left:144px;top:80px;width:550px;height:90px;position:absolute;overflow:hidden;">
                    <div data-to="50% 50%" data-ts="preserve-3d" data-t="0" style="left:550px;top:0px;width:550px;height:90px;position:absolute;overflow:hidden;">
                        <div data-to="50% 50%" data-ts="preserve-3d" data-arr="1" style="left:20px;top:18px;width:200px;height:20px;position:absolute;color:#edf1f2;font-size:17px;font-weight:700;line-height:1.2;letter-spacing:0.1em;">LPPM UDINUS</div>
                        <div data-to="50% 50%" data-ts="preserve-3d" data-arr="2" style="left:19px;top:36px;width:600px;height:30px;position:absolute;color:#edf1f2;font-size:19px;line-height:1.2;letter-spacing:0.05em;"><span style="font-weight:900;color:#e04338;"></span>( Lembaga Penelitian & Pengabdian Masyarakat )</div>
                    </div>
                </div>
            </div>
            <div>
                <img data-u="image" src="/assetAdmin/img/px-beach-daylight-fun-1430675-image.jpg" />
                        ...
                        <div data-to="50% 50%" data-ts="preserve-3d" data-t="4" style="left:0px;top:0px;width:500px;height:400px;position:absolute;">
                            <div data-to="50% 50%" data-ts="preserve-3d" data-t="5" style="left:0px;top:0px;width:500px;height:400px;position:absolute;">
                                <div data-to="50% 50%" data-ts="preserve-3d" data-t="6" style="left:0px;top:0px;width:500px;height:400px;position:absolute;">
                                    <div data-to="50% 50%" data-t="7" style="left:-50px;top:175px;width:600px;height:38px;position:absolute;opacity:0;color:#00a186;font-size:32px;font-weight:700;line-height:1.2;text-align:center;">Lembaga Penelitian & Pengabdian Masyarakat</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div>
                <img data-u="image" src="/assetAdmin/img/px-fun-man-person-2361598-image.jpg" />
                <div data-ts="flat" data-p="2720" data-po="50% 48%" style="left:0px;top:0px;width:980px;height:380px;position:absolute;">
            ...
            <div style="background-color:#000000;">
                <img data-u="image" style="opacity:0.5;" src="/assetAdmin/img/faded-monaco-scenery-evening-dark-picjumbo-com-image.jpg" />
                <div data-ts="flat" data-p="1800" data-po="50% -100%" style="left:120px;top:90px;width:600px;height:300px;position:absolute;">
                    ...
                    <svg viewbox="0 0 500 200" data-to="50% 50%" width="500" height="200" data-t="13" style="left:50px;top:50px;display:block;position:absolute;opacity:0;overflow:visible;">
                        <g>
                            <text fill="#ffffff" x="17" y="110" style="position:absolute;font-family:Montserrat,sans-serif;font-size:32px;font-weight:300;overflow:visible;">llll
                            </text>
            ...
            <div>
                <img data-u="image" src="/assetAdmin/img/px-bloom-blossom-flora-65219-image.jpg" />
...
@section('dashboard')
  ...
  <br>
  <h1>
    <p class="text-center">BORANG KINERJA INOVASI</p>
  </h1>
  <p>Dalam rangka pencapaian indikator kinerja Kementrian Riset, Teknologi, dan Pendidikan Tinggi, yaitu
    Indeks Inovasi, Indeks Perguruan Tinggi, dan Indeks Birokrasi, maka Kementerian Riset, Teknologi, 
    dan Pendidikan Tinggi menyelenggarakan pemeringkatan perguruan tinggi, dengan kinerja inovasi sebagai 
    salah satu indikatornya.
  </p>
  <p>Hasil pengisian borang tersebut dapat dijadikan bahan pertimbangan berbagai kebijakan, seperti pemberian 
    insentif maupun menjadi bahan kerja sama luar negeri yang di inisiasi oleh Direktorat Jenderal Penguatan 
    Inovasi. Data tersebut diharapkan segera dikirim. 
  </p>
