      ...
      <div class="col-md-6 ">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <!-- <div class="col-lg-6  d-lg-block"><img src="/assetAdmin/img/udinus.jpg"></div> -->
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  {{ csrf_field() }}
                    <div class="form-group">
                      <input type="text" name="name" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Masukkan Username...">
                    </div>
                    <div class="form-group">
